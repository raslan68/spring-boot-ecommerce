...
public class ProductController {
    ...
    public ResponseEntity<?> createProduct(@Valid @RequestBody ProductCreateRequest productCreateRequest){
        ...
        return ResponseEntity.ok(new GenericResponse(201, "New Product is successfully created"));
    }
    @PutMapping
    ...
    public ResponseEntity<?> deleteProduct(@PathVariable("id") Long id){
        ...
        return ResponseEntity.ok(new GenericResponse(200, "Successfuly deleted"));
    }
    @GetMapping("/{id}")
